			...
			<div class="header-info">
				...
				<!-- {!!Form::open(['route'=>'login','method'=>'POST'])!!}
					<div class="form-group">
						...
						{!!Form::email('email',null,['class'=>'form-control','paceholder'=>'Ingresa tu correo'])!!}
					</div>
					<div class="form-group">
						{!!Form::label('contrasena','Contraseña: ')!!}
						{!!Form::password('password',['class'=>'form-control','paceholder'=>'Ingresa tu contraseña'])!!}
					</div>
